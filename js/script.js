$(document).ready(function() {
        ...
        function getQuote() {
            var quotes = ['“Just go. Go see all the beauty in the world.”', '“Travel is  fatal to prejudice, bigotry, and narrow mindedness, and many of our people need it sorely on these accounts.”', '"The real voyage of discovery consists not in seeking new landscapes, but in having new eyes.”', '“If you think adventure is dangerous, try routine, it is lethal.”', '“Great things never came from comfort zones.”', '“Don\'t listen to what they say, go see.”', '“Oh, the places you\'ll go!"'];
            var authors = ["~ Unknown", "~ Mark Twain", "~ Marcel Proust", "~ Unknown", "~ Unknown", "~ Chinese Proverb", "~ Dr. Seuss"];
